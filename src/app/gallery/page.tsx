  ...
  return (
    <div className="mx-auto max-w-7xl px-4 py-12 sm:px-6 lg:px-8">
      ...
      <p className="mt-4 max-w-3xl text-lg leading-8 text-slate-300">
        Eigene Illustrationen und redaktionelle Platzhalter. Trailer-Screens sollten spaeter nur sauber eingebettet, lizenziert oder korrekt referenziert werden.
      </p>
      <div className="mt-10">
